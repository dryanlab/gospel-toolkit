...
const navItems = [
  ...
  },
  {
    href: '/readings',
    label: '圣徒伴读',
    labelEn: 'Read with the Saints',
    labelEnShort: 'Readings',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] opacity-60 -mt-0.5">{(item as any).labelEnShort || item.labelEn}</span>
              </div>
            </Link>
          );
        })}
