...
const theology = {
  title_zh: `核心神学：在基督里的属灵福气与教会的奥秘`,
  title_en: `Core Theology: Spiritual Blessings in Christ and the Mystery of the Church`,
  content_zh: `以弗所书被称为"书信中的皇冠"，是保罗对教会本质最深刻的阐述。
...
第四，属灵的争战。"因我们并不是与属血气的争战，乃是与那些执政的、掌权的、管辖这幽暗世界的，以及天空属灵气的恶魔争战"（6:12）。基督徒的争战不是政治斗争或文化战争，而是属灵的争战。神赐下全副军装——真理、公义、平安的福音、信德、救恩、圣灵的宝剑（6:14-17）——每一件都与基督的工作相连。`,
  content_en: `Ephesians has been called "the crown of the epistles" — Paul's most profound exposition of the church's nature.
