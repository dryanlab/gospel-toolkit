...
const theology = {
  title_zh: `核心神学：在基督里的喜乐与谦卑`,
  title_en: `Core Theology: Joy in Christ and the Mind of Humility`,
  content_zh: `腓立比书是保罗在监狱中写的，却是他最喜乐的书信——"喜乐"一词出现十六次。
...
第三，在任何处境中知足。"我并不是因缺乏说这话；我无论在什么景况都可以知足，这是我已经学会了。我知道怎样处卑贱，也知道怎样处丰富……我靠着那加给我力量的，凡事都能做"（4:11-13）。知足不是天生的性情，而是"学会了"的功课；能力不是来自自己，而是来自"那加给我力量的"。`,
  content_en: `Philippians was written from prison, yet it is Paul's most joyful letter — "joy" appears sixteen times.
