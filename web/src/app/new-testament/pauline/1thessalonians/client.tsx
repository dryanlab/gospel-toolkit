...
"So shall we ever be with the Lord" — this is the Christian's ultimate hope. Paul says to comfort one another with these words (4:18). In the face of death, we are not those without hope, because the Lord has risen, and those who sleep in Christ shall also rise. This hope is not a wishful dream but a certainty built upon the Lord's resurrection.`
    ...
    {
      title_zh: `四、在末世盼望中的圣洁生活（5章）`,
      title_en: `IV. Holy Living in Eschatological Hope (Ch. 5)`,
      content_zh: `第五章延续主再来的主题，但切入角度改变了——不再是"何时来"，而是"怎样活"。"主的日子来到，好像夜间的贼一样"（5:2），所以"我们不要睡觉，像别人一样，总要儆醒谨守"（5:6）。
...
这三个命令是整个基督徒生活的缩影：喜乐、祷告、感谢。三者相辅相成——常常喜乐使人能感谢，不住祷告使人与神连接，凡事感谢使人保持心的敞开。保罗补充说："不要消灭圣灵的感动；不要藐视先知的讲论。但要凡事察验，善美的要持守，各等恶事要禁戒不做"（5:19-22）。全书最后以祝福作结："愿赐平安的神亲自使你们全然成圣！你们的灵与魂与体得蒙保守，在我主耶稣基督降临的时候，完全无可指摘。"（5:23）`,
      content_en: `Chapter 5 continues the theme of the Lord's return but from a different angle — not "when" but "how to live." "The day of the Lord so cometh as a thief in the night" (5:2), so "let us not sleep, as do others; but let us watch and be sober" (5:6).
...
const theology = {
  title_zh: `核心神学：主必再来——活泼的盼望`,
  title_en: `Core Theology: The Lord Will Return — A Living Hope`,
  content_zh: `帖撒罗尼迦前书是保罗最早的书信之一，核心主题是基督再来的盼望如何塑造当下的生活。
...
第三，"常常喜乐，不住地祷告，凡事谢恩"（5:16-18）。这三个命令是帖前的精华——喜乐不取决于环境（帖撒罗尼迦教会正受逼迫），祷告不限于特定时刻，感恩包括一切处境。这是"神在基督耶稣里向你们所定的旨意"（5:18）。`,
  content_en: `1 Thessalonians is one of Paul's earliest letters; its core theme is how the hope of Christ's return shapes present living.
