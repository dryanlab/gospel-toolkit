...
const theology = {
  title_zh: `核心神学：被杀的羔羊得胜，万事的终局与新天新地`,
  title_en: `Core Theology: The Slain Lamb Conquers, The End of All Things and the New Creation`,
  content_zh: `启示录不是一本密码书，而是一封写给受逼迫教会的牧养书信。它的核心信息简洁而有力：基督已经得胜，正在得胜，必将完全得胜。
...
第四，新天新地，万物更新。"我又看见一个新天新地"（21:1）。"神要擦去他们一切的眼泪；不再有死亡，也不再有悲哀、哭号、疼痛，因为以前的事都过去了"（21:4）。这不是对现实的逃避，而是对现实的终极更新，创世记中被咒诅的受造界在启示录中被完全恢复。"坐宝座的说：'看哪，我将一切都更新了！'"（21:5）。圣经以一座城（新耶路撒冷）和一棵树（生命树）结束，与创世记的伊甸园遥相呼应，人类失落的家园终于被找回，而且远远超越了原来的荣耀。`,
  content_en: `Revelation is not a code book but a pastoral letter to a persecuted church. Its core message is simple and powerful: Christ has conquered, is conquering, and will fully conquer.
