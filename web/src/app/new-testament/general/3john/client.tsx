...
const sections = [
    {
      title_zh: '一、该犹的好客与宣教的支持（1-8节）',
      title_en: `I. Welcoming Missionaries: The Good Example of Gaius`,
      content_zh: `约翰三书是写给盖犹的个人信件，全信只有15节，却在约翰二书"不可接待异端"之后，提供了一个正面的例子：当接待、支持传道人。
...
盖犹接待了传道人，包括外来的陌生人，被称为"忠心的行事"。这是款待之道（hospitality）的圣经标准——不只接待相识的，也接待陌生的传道人。保罗在罗马书12:13说"客要一味地款待"，希伯来书13:2说"不可忘记用爱心接待客旅，因为曾有接待客旅的，不知不觉就接待了天使"。`,
      content_en: `Third John is a personal letter to Gaius, with only 15 verses. Following Second John's warning against receiving false teachers, it provides a positive example: believers should welcome and support missionaries.
...
Gaius welcomed missionaries, including strangers, and was commended for "faithfully' doing so. This is the biblical standard of hospitality — not only welcoming acquaintances but also welcoming traveling missionaries. Paul in Romans 12:13 says to be "given to hospitality," and Hebrews 13:2 says "Be not forgetful to entertain strangers: for thereby some have entertained angels unawares."`
    ...
    {
      title_zh: `二、丢特腓的专权与低米丢的榜样（9-15节）`,
      title_en: `II. Diotrephes' Tyranny and Demetrius's Example (vv. 9–15)`,
...
const theology = {
  title_zh: `核心神学：好客的美德与教会中的权力滥用`,
  title_en: `Core Theology: The Virtue of Hospitality and the Abuse of Power in the Church`,
  content_zh: `约翰三书是新约最短的书卷之一，通过三个人物展示了教会生活中的光明与黑暗。
...
第三，低米丢的好名声。"低米丢行善，你就效法。行善的属乎神"（11节）。在丢特腓的黑暗衬托下，低米丢代表了真正的属灵品格——被众人称赞，包括被"真理"本身称赞。`,
  content_en: `3 John is one of the shortest New Testament books, using three characters to display light and darkness in church life.
...
const outline = [[`1-4节`,`问安：在真理中行走`,`vv. 1-4`,`Greeting: Walking in Truth`],[`5-8节`,`该犹的忠心接待`,`vv. 5-8`,`Gaius's Faithful Hospitality`],[`9-10节`,`丢特腓的骄傲霸权`,`vv. 9-10`,`Diotrephes's Arrogant Tyranny`],[`11-15节`,`低米丢的美好见证`,`vv. 11-15`,`Demetrius's Good Testimony`]];

const info = { nameZh: `约翰三书`, nameEn: `3 John`, author: `使徒约翰`, date: `约公元85-95年`, chapters: `1章`, backHref: `/new-testament/general`, backLabel: `普通书信`, bibleId: `3JN` };
