...
// Comprehensive traditional ↔ simplified Chinese mapping for search
const t2s: Record<string, string> = {
  // Common worship song characters
  '靜':'静','頌':'颂','嘆':'叹','禰':'祢','裡':'里','裏':'里','麼':'么',
  '為':'为','們':'们','從':'从','來':'来','個':'个','這':'这','過':'过','對':'对','說':'说','後':'后',
  '會':'会','進':'进','開':'开','關':'关','點':'点','樣':'样','問':'问','時':'时','間':'间','長':'长',
  '實':'实','動':'动','應':'应','發':'发','經':'经','書':'书','學':'学','電':'电','與':'与','給':'给',
  '現':'现','將':'将','號':'号','機':'机','無':'无','愛':'爱','讓':'让','請':'请','見':'见','親':'亲',
  '門':'门','車':'车','東':'东','馬':'马','頭':'头','風':'风','輕':'轻','聽':'听','聖':'圣','響':'响',
  '寶':'宝','貴':'贵','獻':'献','歡':'欢','稱':'称','禱':'祷','靈':'灵','華':'华','萬':'万','國':'国',
  '義':'义','還':'还','連':'连','軟':'软','遠':'远','選':'选','邊':'边','離':'离','雖':'虽','難':'难',
  '題':'题','願':'愿','類':'类','飛':'飞','體':'体','齊':'齐','榮':'荣','歲':'岁','歷':'历','歸':'归',
  '殺':'杀','溫':'温','滿':'满','漸':'渐','潔':'洁','當':'当','穩':'稳','築':'筑','範':'范','約':'约',
  '純':'纯','終':'终','統':'统','編':'编','練':'练','總':'总','繫':'系','習':'习','處':'处','記':'记',
  '認':'认','該':'该','誰':'谁','論':'论','講':'讲','識':'识','護':'护','變':'变','讚':'赞','賜':'赐',
  '轉':'转','農':'农','鄰':'邻','釋':'释','鋼':'钢','隨':'随','際':'际','雲':'云','頂':'顶','預':'预',
  '領':'领','飄':'飘','養':'养','駐':'驻','驗':'验','髮':'发','鬥':'斗','魚':'鱼','鳥':'鸟','齡':'龄',
  '復':'复','佈':'布','傳':'传','僅':'仅','億':'亿','優':'优','內':'内','創':'创','劃':'划','勞':'劳',
  '勝':'胜','區':'区','衛':'卫','壓':'压','備':'备','奮':'奋','嬰':'婴','寧':'宁','尋':'寻','導':'导',
  '層':'层','師':'师','幣':'币','幫':'帮','廣':'广','廳':'厅','張':'张','強':'强','價':'价','傑':'杰',
  '衝':'冲','補':'补','製':'制','複':'复','觀':'观','計':'计','設':'设','証':'证','評':'评','調':'调',
  '諸':'诸','豐':'丰','質':'质','趨':'趋','輝':'辉','輪':'轮','達':'达','運':'运','適':'适','遲':'迟',
  '錯':'错','鍵':'键','閃':'闪','閉':'闭','階':'阶','雙':'双','項':'项','順':'顺','額':'额','顯':'显',
  '飾':'饰','歎':'叹','獨':'独','稀':'稀','舉':'举','擧':'举','堅':'坚','擁':'拥','穌':'稣','穡':'穑',
  '稱':'称','穢':'秽','穩':'稳','穫':'获','穰':'穰','穴':'穴','穵':'究','穸':'穸','穹':'穹','空':'空',
  '穻':'穻','穼':'穼','穽':'穽','穾':'穾','穿':'穿','窀':'窀','突':'突','窂':'窂','窃':'窃','窄':'窄',
  // Additional common characters in hymns
  '藉':'借','託':'托','紀':'纪','細':'细','終':'终','絕':'绝','絲':'丝','給':'给','統':'统','絡':'络',
  '結':'结','絢':'绚','絣':'绷','絨':'绒','絮':'絮','経':'经','継':'继','続':'续','総':'总','緑':'绿',
  '緒':'绪','締':'缔','緣':'缘','縁':'缘','編':'编','緩':'缓','縛':'缚','縣':'县','縫':'缝','縱':'纵',
  '總':'总','繁':'繁','繃':'绷','繆':'缪','織':'织','繞':'绕','繡':'绣','繩':'绑','繪':'绘','繫':'系',
  '繭':'茧','繰':'缲','繳':'缴','繹':'绎','纖':'纤','續':'续','纜':'缆','耀':'耀','頌':'颂','頗':'颇',
};
