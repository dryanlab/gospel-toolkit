...
const t2s: Record<string, string> = {'為':'为','們':'们','從':'从','來':'来','個':'个','們':'们','這':'这','過':'过','對':'对','說':'说','後':'后','會':'会','進':'进','裡':'里','開':'开','關':'关','點':'点','樣':'样','問':'问','時':'时','間':'间','長':'长','實':'实','動':'动','應':'应','發':'发','經':'经','書':'书','學':'学','電':'电','與':'与','給':'给','現':'现','將':'将','號':'号','機':'机','無':'无','愛':'爱','讓':'让','請':'请','見':'见','親':'亲','門':'门','車':'车','東':'东','馬':'马','頭':'头','風':'风','輕':'轻','聽':'听','聖':'圣','響':'响','寶':'宝','貴':'贵','獻':'献','歡':'欢','歌':'歌','稱':'称','禱':'祷','靈':'灵','華':'华','萬':'万','國':'国','義':'义','還':'还','連':'连','軟':'软','遠':'远','選':'选','邊':'边','離':'离','雖':'虽','難':'难','題':'题','願':'愿','類':'类','飛':'飞','體':'体','齊':'齐','榮':'荣','歲':'岁','歷':'历','歎':'叹','歸':'归','殺':'杀','溫':'温','滿':'满','漸':'渐','潔':'洁','當':'当','發':'发','稱':'称','穩':'稳','築':'筑','範':'范','約':'约','純':'纯','終':'终','統':'统','經':'经','編':'编','練':'练','總':'总','繫':'系','習':'习','處':'处','號':'号','記':'记','認':'认','該':'该','誰':'谁','論':'论','講':'讲','識':'识','護':'护','變':'变','讓':'让','讚':'赞','賜':'赐','輕':'轻','轉':'转','農':'农','邊':'边','鄰':'邻','釋':'释','鋼':'钢','關':'关','隨':'随','際':'际','離':'离','雲':'云','頂':'顶','預':'预','領':'领','飄':'飘','養':'养','駐':'驻','驗':'验','髮':'发','鬥':'斗','魚':'鱼','鳥':'鸟','點':'点','齡':'龄','復':'复','從':'从','禰':'祢','裏':'里','麼':'么','佈':'布','傳':'传','僅':'仅','億':'亿','優':'优','內':'内','創':'创','劃':'划','動':'动','勞':'劳','勝':'胜','區':'区','衛':'卫','壓':'压','備':'备','奮':'奋','嬰':'婴','寧':'宁','尋':'寻','導':'导','層':'层','師':'师','幣':'币','幫':'帮','廣':'广','廳':'厅','張':'张','強':'强','歸':'归','價':'价','傑':'杰','衝':'冲','補':'补','製':'制','複':'复','觀':'观','計':'计','設':'设','証':'证','評':'评','調':'调','諸':'诸','豐':'丰','質':'质','趨':'趋','輝':'辉','輪':'轮','達':'达','運':'运','適':'适','遲':'迟','錯':'错','鍵':'键','閃':'闪','閉':'闭','階':'阶','雙':'双','項':'项','順':'顺','額':'额','類':'类','顯':'显','飾':'饰'};
